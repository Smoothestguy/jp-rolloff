...
We are JP Roll-Off Service, a family-owned hauler, and Grovehurst is an easy run for us by way of Route 197 or the BW Parkway. When you call, you reach the family that owns the trucks — not a call center, not a dispatcher reading off a script.
...
- **Mid-size roofing tear-offs.** A single-layer asphalt tear-off on one of these Colonial roofs fits comfortably; shingles are dense, so let us know it is a roofing job and we will quote it accordingly. Brick-and-vinyl exteriors and the neighborhood's mature tree canopy also drive a steady stream of siding, deck, sunroom, and roof projects.
