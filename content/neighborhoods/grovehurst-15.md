...
So the 15 fits on two counts: it swallows a contained, one-room project in a 1990s Colonial, and its compact footprint stages cleanly on the kind of private property Grovehurst homes actually have. If you are gutting most of a house at once, clearing a full estate, or tearing off a large multi-layer roof on one of the bigger 4,200-square-foot models, you may want to step up to a 20. For a single defined project in a Grovehurst home, the 15 is usually the right call.

## Which Grovehurst projects suit the 15-yard
...
**Mind the trees and the back lot line.** Grovehurst's lots back up to hardwood forest, and the canopy is part of what makes the neighborhood. When we site the container, we keep clear of low limbs and soft ground near the tree line so the truck has a firm, open path in and out. If your staging spot is tight against the woods or down a sloped side yard, tell us when you call and we will plan the approach.
