...
## Which Upper Marlboro jobs suit the 15-yard
...
There is one more job worth naming here. Downtown Upper Marlboro has a long, documented flooding problem from the Western Branch — Water Street has been closed by high water more than once, and dozens of structures in the town sit in flood-prone ground. A flood-damage cleanout or a gut of one waterlogged level is very often a 15-yard job, and on those we pay extra attention to dry, firm placement.

If your project is bigger — a whole-home cleanout on a large estate lot, a barn or outbuilding teardown on one of the area's horse farms, or framing and post-build debris from a Westphalia or Marlton new build — that may push you toward a 20 or a 30. We will tell you straight which size your job needs rather than talk you into a container you cannot fill.

## Local logistics: placement, permits, and drive time

**The permit question swings on which side of town you are on.** This is the part of Upper Marlboro that trips people up, so we always ask first: are you in the historic downtown core, or out in the county?

If you are in the **Town of Upper Marlboro** (the historic core), the town has its own rule. A roll-off can sit on your private property — driveway or yard — for **up to 15 days without a town permit**. You need a town permit if the container stays longer than 15 days, or if it has to sit in the town's right-of-way (the street or sidewalk). For those details the town points residents to Town Hall at (301) 627-6905. The town also enforces Prince George's County permits for qualifying construction, watched by its own code enforcement officers.

If you are in the **rest of 20772 or 20774** — under Prince George's County — the general rule is simpler: a container on your private driveway or yard does not need a permit, but placing it in the public right-of-way does. Out here that is rarely an issue, because so much of the county side is large-lot and estate property with long private driveways. Plenty of those lots could hold a 30-yard without ever touching the street, so a 15 is no trouble at all.

The placement reality also shifts with the housing. Town-wide, Upper Marlboro runs roughly half detached homes and a large share of row and attached homes — a townhouse-heavy mix in places like Marlton and the newer Westphalia townhome streets, where driveways are narrower and curbside swing is tighter. We will scout the spot with you when the driveway is snug. A 15-yard needs about 14 feet of straight length plus a little clearance and an open swing for the rear door, and we lay boards under the wheels on request to protect a finished driveway.
...
Upper Marlboro has been the seat of Prince George's County since 1721, and it carries that split character to this day — a small, historic, flood-prone downtown core wrapped by rural land, horse farms, and fast-growing new construction. We have run enough containers through both sides to know the questions that matter: which jurisdiction you are in, how long you need the can, and whether your driveway can take it. Tell us your Upper Marlboro address and what you are tackling — a downtown kitchen, a two-bath gut, a roof tear-off on a county lot — and we will confirm the 15-yard is the right call and quote you on the spot. Call JP Roll-Off Service at **(301) 252-3586**.
