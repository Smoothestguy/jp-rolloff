Takoma Park is one of the Washington area's oldest planned streetcar suburbs — founded in 1883 and home to a historic district of more than 600 contributing buildings dating from the 1880s to the 1930s. Roll-off work here tends to be renovation and removal on century-old homes rather than new construction. So when a Takoma Park job is big enough to call for a 30-yard — a full demolition, a commercial site, a multi-family cleanout — the volume of debris is rarely the hard part. The hard part is finding a spot to physically set a 22-foot box under a dense tree canopy, on narrow hilly streets, where the city steers you firmly toward the driveway. That is the question we sort out with you before we roll.

We are JP Roll-Off Service, a family-owned hauler. Takoma Park is a short run for us, and the 30-yard is the container we bring when a smaller bin would only mean a second haul.

## What fits in a 30-yard dumpster

The 30-yard is one of the largest boxes we run and the one most people know as the "commercial and demo" size. It measures 22 ft long by 8 ft wide by 6 ft tall and swallows roughly 14 pickup-truck loads of debris. A 30-yard in Takoma Park is **quoted by material — call for a quote**. That quote includes delivery and a 14-day rental, with pickup on request when you call to schedule. Additional days are available on request when you book, and heavy material such as concrete, dirt, brick and shingles is quoted separately because weight matters.
...
If your project is closer to a single-room remodel, a roof tear-off, or a modest basement or attic cleanout in one of these older homes, a smaller box will save you money, and we will tell you so. The 30 is for the heavy, high-volume work.

## Local logistics: trees, narrow streets, and the city permit
...
**The driveway-preferred permit rule.** The City of Takoma Park, through its Public Works Department, requires a permit for any dumpster placed in the street or city right-of-way, and many blocks ban street placement outright. The city is explicit that **no permit is required if the container sits in the driveway** — and it also warns that you may not set the box until you have received written notice that the permit is granted. So a driveway drop is by far the cleaner path here. If your only workable spot is the curb, plan for the permit and the wait, and we will flag it when we look at your address. Because permit language can change, we confirm the current requirement for your exact location before we schedule a street drop.

**Ground and room.** A 30-yard at capacity is a serious amount of steel and debris, so the surface under it has to carry the load. On a small historic-district lot with trees and close neighbors, that means a careful look at where the box can sit without crowding the line or blocking the only driveway access. We lay boards under the wheels on request to spread the load and protect the spot.

**Neighborhood reference points.** If you are working in Old Takoma, North Takoma, Hampshire Knolls, or along the Maple Avenue corridor, those are exactly the areas where canopy clearance, street width, and the permit question all need a closer look. Note that Takoma Park straddles the Montgomery County / Prince George's County line, so projects on the eastern edge can fall under PG County for non-city right-of-way matters. Tell us the cross street or a landmark — the Takoma Park Metro station, the Sunday farmers market, Sligo Creek — and we will picture the approach before we commit a truck to it.

**Drive time.** Takoma Park is a short run for us, so scheduling is fast. The catch is always placement, not distance: the tight historic streets and low limbs mean we want to know the spot ahead of time so the truck arrives ready to set the box where it actually fits.
