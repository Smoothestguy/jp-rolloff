...
- **Roofing tear-off.** A single-layer tear-off on a typical Riverdale Park bungalow or Foursquare fits this size, though heavy multi-layer or slate jobs can run up against the weight allowance fast, so give us a call to talk tonnage first.
