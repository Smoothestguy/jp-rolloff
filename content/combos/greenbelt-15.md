...
We are JP Roll-Off Service, a family-owned hauler dispatched out of Beltsville. When you call, you reach the owners, not a call center, and Beltsville is only about ten minutes from most Greenbelt addresses — your dumpster's not far behind.

## What fits in a 15-yard dumpster

The 15-yard measures 14 ft long by 8 ft wide by 4 ft tall and holds roughly four and a half pickup-truck loads of debris. It comes with a 1.5-ton (3,000 lb) weight allowance, and in Greenbelt a typical 15-yard rental runs **$425 to $485, including delivery, pickup, and that tonnage**. No tipping-fee surprises tacked on after the haul.
...
## Which Greenbelt jobs suit the 15-yard

Greenbelt's housing covers more eras than almost any other town its size, and each one feeds the kind of single-room work the 15-yard is built for.

- **Kitchen remodel.** Pulling cabinets, countertops, flooring, and drywall from one kitchen fills a 15-yard about right without paying for space you won't use.
- **Roofing tear-off.** A single-layer asphalt tear-off on a typical Greenbelt home fits comfortably, with the 1.5-ton allowance covering most jobs that size. Heavier or multi-layer tear-offs may need the next size up, and we will tell you straight.
...
In **Old Greenbelt**, the National Historic Landmark core, the housing is something you won't find anywhere else in the DMV: roughly 1,600 cooperative row houses owned by Greenbelt Homes, Inc. (GHI), built by the federal government starting in 1936-37 with defense-era wood-frame units added in 1941-42. These attached homes sit in rows of two to eight around shared interior "garden side" courts, with parking, trash, and services pushed to the outer edge of each grouping. Most of the original units sit on crawlspaces and boiler rooms rather than full basements, and GHI's long-running Homes Improvement Program added insulation, air sealing, and crawlspace vapor barriers across the community. The practical result is a steady stream of weatherization, interior-gut, and single-room renovation jobs — precisely 10- and 15-yard work — rather than big demolition.

**Greenbelt East, Greenbriar, and Hunting Ridge** are a different era entirely. Greenbelt East's homes were built almost wholly between 1970 and 1999 and skew heavily toward condos, townhomes, and apartments, and the Greenbriar condominium community dates to about 1975. That means a kitchen or two-bath remodel here usually happens inside an HOA or condo association, so placement gets coordinated rather than dropped at the curb. Out toward the Greenbelt Metro/MARC station, the newer Greenbelt Station townhomes (built and sold out in the 2010s) have narrow private driveway aprons in front of one-car garages — the realistic spot for a 15-yard during a finish-the-basement or flooring job.

## Local logistics: placement, permits, and drive time

**The Old Greenbelt wrinkle.** This is what sets Greenbelt apart from any other town we serve. Because the GHI row houses are arranged around shared interior courts with parking and trash on the outer side, a roll-off serving a court home often **cannot sit beside the unit** — it has to stage in the shared exterior parking lot or court drive. On top of that, GHI is a true cooperative: any improvement, alteration, or addition to a GHI home requires a GHI permit, and contractors must produce the approved permit for the scope of work before starting. Crawlspace jobs need a call to the GHI Staff Engineer first. So a court placement gets layered approval — GHI sign-off on the work and the staging spot, on top of the city's rule below. Tell us it is a GHI home when you call and we will plan the drop around the court geometry.
