...
- **Roofing tear-off.** A single-layer asphalt tear-off on a typical Greenbelt home fits comfortably — shingles are heavy, so tell us it is a roof job when you call and we will quote it accordingly. Heavier or multi-layer tear-offs may need the next size up, and we will tell you straight.
