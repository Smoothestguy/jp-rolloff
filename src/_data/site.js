...
export default {
  ...
  email: "office@jprolloff.net",
  // Public-facing location only — owner does not want a specific street address advertised.
  address: "Silver Spring, MD",
  founded: 2000,
  // Primary nav — edit once, renders in nav.njk on every page.
  nav: [
    { href: "/services", label: { en: "Dumpsters", es: "Contenedores" } },
    { href: "/demolition", label: { en: "Demolition", es: "Demolición" } },
    { href: "/emergency", label: { en: "Emergency", es: "Emergencias" } },
